...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gopay-darker flex items-center justify-center px-4">
      {/* Background Effects */}
        ...
        <div className="glass rounded-3xl p-8">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">Entre na sua conta GoPay</p>
            </div>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 text-gray-400 cursor-pointer">
                <input type="checkbox" className="rounded border-gopay-border bg-gopay-dark" />
                Lembrar-me
              </label>
              <a href="#" className="text-gopay-blue hover:underline">Esqueceu a senha?</a>
            </div>
          ...
          <p className="mt-8 text-center text-gray-500">
            Não tem conta?{' '}
            <Link href="/register" className="text-gopay-blue hover:underline font-medium">
              Criar conta grátis
            </Link>
          </p>
        </div>
